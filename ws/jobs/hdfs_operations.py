...
class HdfsOp(object):
    def __init__(self, web_hdfs_url='https://webhdfs.memexproxy.com:443/webhdfs/v1', user='digdemos',
                 password='pn,JpoL9D+XH3V'):
    ...
    def create_dir(self, path, hdfs_user='worker'):
        ...
        print url
        return requests.put(url, auth=HTTPBasicAuth(self.user, self.password))
