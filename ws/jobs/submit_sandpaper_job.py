...
if __name__ == '__main__':
    ...
    property_dict["INPUT"] = "/user/worker/cdr3/domain3/etk_out/ce_domain/19"
    property_dict["OUTPUT"] = "/user/worker/cdr3/domain3/sandpaper_out/ce_domain/19"
    property_dict["INDEX"] = "ce_domain_deployed"
