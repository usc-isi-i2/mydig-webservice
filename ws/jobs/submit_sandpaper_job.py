...
if __name__ == '__main__':
    ...
    property_dict["INPUT"] = "/user/worker/cdr3/domain4/etk_out/sec_domain/23"
    property_dict["OUTPUT"] = "/user/worker/cdr3/domain4/sandpaper_out/sec_domain/23"
    property_dict["INDEX"] = "sec_domain_deployed"
