...
default_fields = {
    ...
    'phone': {
        ...
        'description': 'phones mentioned in the page',
        'type': 'string',
        'show_in_search': True,
        'show_in_facets': True,
        'show_as_link': 'text',
    ...
    'state': {
        ...
        'description': 'USA Canada states mentioned in the page',
        'type': 'string',
        'show_in_search': True,
        'show_in_facets': True,
        'show_as_link': 'text',
    ...
    'email': {
        ...
        'description': 'emails mentioned in the page',
        'type': 'string',
        'show_in_search': True,
        'show_in_facets': True,
        'show_as_link': 'text',
    ...
    'stock_ticker': {
        'name': 'stock_ticker',
        'screen_label': 'Stock Ticker',
        'screen_label_plural': 'Stock Tickers',
        'description': 'Stock tickers mentioned in page',
        'type': 'string',
        'show_in_search': True,
        'show_in_facets': True,
        'show_as_link': 'entity',
